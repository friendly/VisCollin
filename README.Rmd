...
The diagnostic measures introduced by Belesley (1991) are based on the eigenvalues $\lambda_1, \lambda_2, \dots \lambda_p$
...
* Dimension 6 reflects the high corelation between number of cylinders and engine displacement.
